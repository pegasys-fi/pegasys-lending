...
//   let _tokenInstances: iAssetsWithoutSYS<MintableERC20Instance>
...
//     //user 2 deposits 5 SYS tries to borrow. needs to be reverted as you can't borrow more than 25% of the available reserve (250 DAI)
//     const amountSYSToDeposit = await convertToCurrencyDecimals(SYSEREUM_ADDRESS, "5")
//     await _lendingPoolInstance.deposit(SYSEREUM_ADDRESS, amountSYSToDeposit, "0", {
//       from: _borrowerAddress,
//       value: amountSYSToDeposit,
//     })
...
//     //user deposits 5 SYS as collateral
//     const amountSYSToDeposit = await convertToCurrencyDecimals(SYSEREUM_ADDRESS, "5")
//     await _lendingPoolInstance.deposit(SYSEREUM_ADDRESS, amountSYSToDeposit, "0", {
//       from: user,
//       value: amountSYSToDeposit,
...
//     //user tries to borrow the DAI at a stable rate using the SYS as collateral
